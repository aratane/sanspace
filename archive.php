                        ...
                        <div class="col-lg-12">
                            <div class="animated-text-wrapper-r">
                                <div class="animated-text-r">
                                    <?php for ($i=0; $i<=9 ; $i++) {?>
                                        <div class="animated-text-content-r"><?php printf( esc_html__( '%s', 'creativex' ), get_the_archive_title() );?> <?php echo esc_html__( '&nbsp;', 'creativex' );?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="animated-text-wrapper-l">
                                <div class="animated-text-l">
                                    <?php for ($i=0; $i<=4 ; $i++) {?>
                                        <div class="animated-text-content-l"><?php printf( esc_html__( '%s', 'creativex' ), get_the_archive_title() );?> <?php echo esc_html__( '&nbsp;', 'creativex' );?></div>
                                    <?php } ?>
                                    <?php for ($i=0; $i<=4 ; $i++) {?>
                                        <div class="animated-text-content-r"><?php printf( esc_html__( '%s', 'creativex' ), get_the_archive_title() );?> <?php echo esc_html__( '&nbsp;', 'creativex' );?></div>
                                    <?php } ?>
