                        ...
                        <div class="col-lg-12">
                            <div class="animated-text-wrapper-r">
                                <div class="animated-text-r">
                                    <?php for ($i=0; $i<=9 ; $i++) {?>
                                        <div class="animated-text-content-r"><span><?php echo esc_html__( 'Search.&nbsp;', 'creativex' );?></span></div>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h1 class="section-header-news section-header-news-modal">
                                <?php printf( esc_html__( 'Search Results for: %s', 'creativex' ), get_search_query() );?>
                            </h1>
                            <div class="divider-l"></div>
                        </div>
                    </div>    
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="animated-text-wrapper-l">
                                <div class="animated-text-l">
                                    <?php for ($i=0; $i<=4 ; $i++) {?>
                                        <div class="animated-text-content-l"><span><?php echo esc_html__( 'Search.&nbsp;', 'creativex' );?></span></div>
                                    <?php } ?>
                                    <?php for ($i=0; $i<=4 ; $i++) {?>
                                        <div class="animated-text-content-r"><span><?php echo esc_html__( 'Search.&nbsp;', 'creativex' );?></span></div>
                                    <?php } ?>
                ...
                <div class="extra-margin-container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="news-info">
                                <h3>
                                    <?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'creativex' ) ;?>
                                </h3>
                            </div>
                            <?php get_search_form();  ?>
                            <div class="divider-l"></div>
