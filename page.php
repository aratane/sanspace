...
<div class="news-modal">
    <div class="lower-page lower-page-modal">
        <div class="modal-content">
                        ...
                        <div class="col-lg-12">
                            <div class="animated-text-wrapper-r">
                                <div class="animated-text-r">
                                    <?php for ($i=0; $i<=9 ; $i++) {?>
                                        <div class="animated-text-content-r"><span><?php echo esc_html__( 'The', 'creativex' );?></span><?php echo esc_html__( ' blog.&nbsp;', 'creativex' );?></div>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
            ...
            <?php print wp_specialchars_decode($blog_owl); ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="animated-text-wrapper-l">
                                <div class="animated-text-l">
                                    <?php for ($i=0; $i<=4 ; $i++) {?>
                                        <div class="animated-text-content-l"><span><?php echo esc_html__( 'The', 'creativex' );?></span><?php echo esc_html__( ' blog.&nbsp;', 'creativex' );?></div>
                                    <?php } ?>
                                    <?php for ($i=0; $i<=4 ; $i++) {?>
                                        <div class="animated-text-content-r"><span><?php echo esc_html__( 'The', 'creativex' );?></span><?php echo esc_html__( ' blog.&nbsp;', 'creativex' );?></div>
                                    <?php } ?>
